-- Darkroom schema (Cloudflare D1 / SQLite).
-- Applied automatically by the Worker on first request, and re-runnable by hand:
--   npx wrangler d1 execute darkroom --file=./schema.sql
